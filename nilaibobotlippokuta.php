...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="kriteria_lippokuta1">Kriteria 1:</label>
                ...
                <div class="col">
                    <label for="comparison_lippokuta1">Nilai Perbandingan:</label>
                ...
                <div class="col">
                    <label for="kriteria_lippokuta2">Kriteria 2:</label>
        ...
        if (isset($_POST['submit'])) {
            ...
            foreach ($tenants_lippokuta as $tenant_lippokuta1) {
                echo "<tr>";
                echo "<th>$tenant_lippokuta1</th>";
                $rowTotalLippoKuta = 0; // Stores totals per row
