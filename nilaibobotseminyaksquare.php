...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="kriteria_square1">Kriteria 1:</label>
                ...
                <div class="col">
                    <label for="comparison_square1">Nilai Perbandingan:</label>
                ...
                <div class="col">
                    <label for="kriteria_square2">Kriteria 2:</label>
        ...
        if (isset($_POST['submit'])) {
            ...
            foreach ($tenants_square as $tenant_square1) {
                echo "<tr>";
                echo "<th>$tenant_square1</th>";
                $rowTotalSquare = 0; // Stores totals per row
