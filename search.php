                            ...
                            <div class="card h-100 shadow">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-auto ml-auto d-flex justify-content-end">
                                        <a href="#" class="btn btn-primary view-details" data-bs-toggle="modal" data-bs-target="#detailModal" data-details-url="<?= $detailsUrl ?>" data-mall="<?= urlencode($dat['namaMall']) ?>">View Details</a>
                                    </div>
