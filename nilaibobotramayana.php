...
<body>
    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="kriteria_ramayana1">Kriteria 1:</label>
                ...
                <div class="col">
                    <label for="comparison_ramayana1">Nilai Perbandingan:</label>
                ...
                <div class="col">
                    <label for="kriteria_ramayana2">Kriteria 2:</label>
        ...
        if (isset($_POST['submit'])) {
            ...
            foreach ($tenants_ramayana as $tenant_ramayana1) {
                echo "<tr>";
                echo "<th>$tenant_ramayana1</th>";
                $rowTotalRamayana = 0; // Stores totals per row
            ...
            $lambdaMaxRamayana = 0;
            foreach ($tenants_ramayana as $tenant_ramayana) {
                $lambdaMaxRamayana += $totalValuesRamayana[$tenant_ramayana] * $normalizedRowTotalsRamayana[$tenant_ramayana];
            }
