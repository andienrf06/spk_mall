...
// Check if data is retrieved successfully
if ($data) {
    $geraiBaliCollectionFound = false; // Inisialisasi flag untuk menandai apakah data Gerai Trans Studio Mall Bali (5) ditemukan
    foreach ($data as $row) {
        // Check apakah nama gerai adalah Gerai Trans Studio Mall Bali (5)
        if ($row['namaGerai'] == 'Gerai Trans Studio Mall Bali (5)') {
            // Tandai bahwa data Gerai Trans Studio Mall Bali (5) ditemukan
            $geraiBaliCollectionFound = true;

            // Tampilkan detail data untuk Gerai Trans Studio Mall Bali (5)
    ...
    // Jika data Gerai Trans Studio Mall Bali (5) tidak ditemukan, tampilkan pesan
    if (!$geraiBaliCollectionFound) {
        echo "<p>Data untuk Gerai Trans Studio Mall Bali (5) tidak ditemukan.</p>";
    }
} else {
