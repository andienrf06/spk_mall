...
// Check if data is retrieved successfully
if ($data) {
    $geraiBaliCollectionFound = false; // Inisialisasi flag untuk menandai apakah data Gerai Trans Studio Mall Bali (2) ditemukan
    foreach ($data as $row) {
        // Check apakah nama gerai adalah Gerai Trans Studio Mall Bali (2)
        if ($row['namaGerai'] == 'Gerai Trans Studio Mall Bali (2)') {
            // Tandai bahwa data Gerai Trans Studio Mall Bali (2) ditemukan
            $geraiBaliCollectionFound = true;

            // Tampilkan detail data untuk Gerai Trans Studio Mall Bali (2)
    ...
    // Jika data Gerai Trans Studio Mall Bali (2) tidak ditemukan, tampilkan pesan
    if (!$geraiBaliCollectionFound) {
        echo "<p>Data untuk Gerai Trans Studio Mall Bali (2) tidak ditemukan.</p>";
    }
} else {
